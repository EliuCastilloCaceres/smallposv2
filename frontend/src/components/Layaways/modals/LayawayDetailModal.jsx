...
const LayawayDetailModal = ({ layawayId, canManage, onClose, onChanged, branch }) => {
  ...
  // ya no hace falta un selector manual de sucursal aparte.
  ...
  const handlePay = async () => {
    ...
    // se exigía para efectivo. Además de dar trazabilidad consistente con
    // el POS, es de donde sale la sucursal y de donde saldrá el
    // cash_register_id de la orden si este abono completa el apartado.
                  ...
                  showPayForm ? (
                    <div className="lwy-limit-edit">
                      ...
                      {/* FIX: la caja ahora es obligatoria para cualquier
                          abono, no solo efectivo — igual que en el POS. */}
                      <div className="lwy-field">
                        <label className="lwy-field__label">Caja donde se registrará el abono</label>
